...
@Component({
  ...
  templateUrl: './hostel-inventory-dashboard.component.html',
  styleUrl: './hostel-inventory-dashboard.component.css'
})
export class HostelInventoryDashboardComponent {
  selectedTabIndex = 0;
  isLoading = false;
  ...
  loadReportByTab(tabIndex: number): void {
    ...
    this.reportName = 'Hostel Inventory Management';
