...
@Component({
 ...
 standalone: true,
  ...
  templateUrl: './syllabusprogress.component.html',
  styleUrl: './syllabusprogress.component.css'
})
export class SyllabusprogressComponent {
  selectedTabIndex = 0;
  isLoading = false;
  ...
  loadReportByTab(tabIndex: number): void {
    ...
    this.reportName = 'Syllabus Progress Tracker';
