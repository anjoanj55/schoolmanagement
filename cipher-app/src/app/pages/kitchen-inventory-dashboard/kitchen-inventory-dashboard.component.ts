...
@Component({
  ...
  templateUrl: './kitchen-inventory-dashboard.component.html',
  styleUrl: './kitchen-inventory-dashboard.component.css'
})
export class KitchenInventoryDashboardComponent {
  selectedTabIndex = 0;
  isLoading = false;
  ...
  loadReportByTab(tabIndex: number): void {
    ...
    this.reportName = 'Kitchen Inventory Management';
