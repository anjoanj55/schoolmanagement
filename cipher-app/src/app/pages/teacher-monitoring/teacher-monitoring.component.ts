...
@Component({
 ...
 standalone: true,
  ...
  templateUrl: './teacher-monitoring.component.html',
  styleUrl: './teacher-monitoring.component.css'
})
export class TeacherMonitoringComponent {
  selectedTabIndex = 0;
  isLoading = false;
  ...
  loadReportByTab(tabIndex: number): void {
    ...
    this.reportName = 'Teachers_Reports Load Monitering';
